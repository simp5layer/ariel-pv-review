...
const LandingPage: React.FC<LandingPageProps> = ({ onCreateNew, onViewHistory, hasProjects }) => {
  return (
      ...
      <div className="max-w-3xl mx-auto px-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-primary/10 mb-2">
            <img src={arialLogo} alt="Ariel" className="w-14 h-14 object-contain" />
          </div>
          <h1 className="text-4xl font-bold text-foreground">Welcome to Ariel</h1>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card 
            className={`group cursor-pointer transition-all hover:shadow-lg animate-slide-up ${
              hasProjects ? 'hover:border-primary/50' : 'opacity-60'
            }`}
